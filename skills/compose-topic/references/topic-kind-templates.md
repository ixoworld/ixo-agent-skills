...
Custom labels extend exactly one base Kind. The canonical Job Profile remains a Task specialization with Base Recipe `project`; it does not become a ninth protocol Kind.
