...
Before writing any conversational update, read `references/user-guidance.md`. Lead with the
strongest conclusion the analysis can honestly support and the reason it cannot support a stronger
one. Explain the credible alternative cause, missing comparison, or fragile assumption that matters
most. Say what evidence or design change would resolve it. Pass, warning, failure, blocker, and tier
counts belong in optional technical details, not in the opening explanation.
